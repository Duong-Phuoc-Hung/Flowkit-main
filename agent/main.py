...
async def lifespan(app: FastAPI):
    ...
    if platform.system() != "Windows":
        try:
            ...
            loop.add_signal_handler(signal.SIGINT, controller.request_shutdown)
        except NotImplementedError:
            pass
    else:
        logger.info("Windows detected: Skipping signal handlers.")

    # 3. Load custom materials từ DB (Giữ nguyên logic cũ của bạn)
    ...
    # 6. Quy trình tắt máy (Giữ nguyên)
